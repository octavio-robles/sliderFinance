...
#'
#'
calculate_rolling_market_regime <- function(x,column, lookback = 100) {

  daily_returns <- mu <- standard_deviation <-  NULL
    ...
    dplyr::mutate(x,
                  ...
                  market_regime = dplyr::case_when(sqn >= 1.7 ~ as.factor("Bull Volatile"),
